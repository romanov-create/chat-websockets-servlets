...
The `type` property indicates the type of data that will be found in the `payload` property. For more details, refer to the [`WebSocketMessage`](src/main/java/com/romanov/example/chat/model/WebSocketMessage.java) class.
...
- [`AuthenticationServlet`](src/main/java/com/romanov/example/chat/security/AuthenticationServlet.java)
- [`AccessTokenFilter`](src/main/java/com/romanov/example/chat/security/AccessTokenFilter.java)
- [`Authenticator`](src/main/java/com/romanov/example/chat/security/Authenticator.java)

[`Authenticator`](src/main/java/com/romanov/example/chat/security/Authenticator.java) relies on [Guava Cache][] to keep the track of the tokens and expire them after a few seconds.
